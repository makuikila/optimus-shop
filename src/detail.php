...
<body>
    ...
    <?php $detail = $_GET['details'];
            ...
            <div class="article col-md-12 col-sm-12 col-xs-12">
                <?php
$verif2 =  $DB->connectBD()->query("SELECT *,date_format(date_ajout, 'poster le %d/%m/%Y à %Hh') as date_pro FROM users inner join produit on users.id = produit.id_users where produit.etat = 'en vente' and categorie='itech' order by produit.id_produit desc");
...
?>
            ...
            <div class="article col-md-12 col-sm-12 col-xs-12">
            <?php
                $verif =  $DB->connectBD()->query("SELECT *,date_format(date_ajout, 'poster le %d/%m/%Y à %Hh') as date_pro FROM users inner join produit on users.id = produit.id_users where produit.etat = 'en vente' and categorie='mode' order by produit.id_produit desc");
