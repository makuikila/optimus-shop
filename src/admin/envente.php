...
<section class=" affmobile col-md-12 col-sm-12 col-xs-12"> 
    <div class="col-md-4 col-sm-4 col-xs-4">
        ...
        <section class="contenu">
            ...
            <p>Prix</p>
        <?php 
        $rep1 = $DB->connectBD()->query("SELECT * FROM produit where etat='en vente' order by id_produit desc");
        while($donnee1 = $rep1->fetch()){
            ...
            <?php
                    ...
                    ?>
            <a href="modif.php"><i class="fa fa-paint-brush"></i></a>
        </section>   
        </div>
    </section>
</body>
